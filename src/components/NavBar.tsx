  ...
  return (
    <>
      ...
      {year && dateInfo && (dateInfo[city as 'ba' | 'ke']) && (
        <div className="fixed top-[57px] left-0 right-0 z-40 bg-[#8ebc35]/10 border-b border-[#8ebc35]/20 text-center py-2 text-sm text-white/90 font-medium tracking-wide">
