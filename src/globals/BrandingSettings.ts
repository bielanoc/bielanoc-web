      ...
      fields: [
        {
          ...
          type: 'upload',
          relationTo: 'media',
          admin: { description: 'Main homepage image for Bratislava section.' },
        },
        {
          name: 'imageBAHover',
          ...
          type: 'upload',
          relationTo: 'media',
          admin: { description: 'Image shown on hover for Bratislava section.' },
        },
        {
          name: 'imageKE',
          label: 'Košice — Image',
          type: 'upload',
          relationTo: 'media',
          admin: { description: 'Main homepage image for Košice section.' },
        },
        {
          name: 'imageKEHover',
          ...
          type: 'upload',
          relationTo: 'media',
          admin: { description: 'Image shown on hover for Košice section.' },
        },
      ],
    },
    {
